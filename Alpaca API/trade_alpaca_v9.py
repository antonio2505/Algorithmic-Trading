...
def main():
    ...
    for ticker in tickers:
        ...
        print("last bbRSI   :", last_rsi)
        print("last bbRSI2  :", last_rsi_2)
        print("last %D      :", last_D)
        ...
        if stoch_signal[ticker]=="oversold" and last_rsi_2 <=30 and last_rsi >=30 and existing_pos == False:
        ...
        elif stoch_signal[ticker]=="overbought" and last_rsi_2 >=70 and last_rsi <=70 and existing_pos == False:
