...
def main():
    ...
    for ticker in tickers:
        ...
        last_rsi_2 = historicalData[ticker]["rsi"].iloc[-2]
        ...
        if stoch_signal[ticker]=="oversold" and last_rsi >=30 and existing_pos == False:
            if last_rsi_2 <=30:
        ...
        elif stoch_signal[ticker]=="overbought" and last_rsi <=70 and existing_pos == False:
            if last_rsi_2 >=70:
